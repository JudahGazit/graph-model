...
class FuelCost(ICost):
    def __optimal_fuel_cost(self):
        ...
        for i in range(self.graph_dataset.number_of_edges - self.graph_dataset.number_of_nodes + 1):
    ...
    def __choose_edge(self, adjacency, minimal):
        ...
        data = shortest_path - self.graph_dataset.distances
    ...
    def __add_worst_edge(self, adjacency):
        ...
        adjacency[source, target] = self.graph_dataset.distances[source, target]
        adjacency[target, source] = self.graph_dataset.distances[target, source]
