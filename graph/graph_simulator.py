...
class GraphSimulator:
    ...
    def simulate(self):
        ...
        distances = np.mat([[perimeter_distance(i, j, self.num_leaves) if i != j else 0
                             for j in range(self.num_leaves)] for i in range(self.num_leaves)])
        graph_dataset = GraphDataset(graph, distances)
